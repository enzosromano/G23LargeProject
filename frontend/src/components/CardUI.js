...
function CardUI()
{
    ...
    return(
        <div id="cardUIDiv">
            ...
            <button type="button" id="searchCardButton" class="buttons" onClick={searchCard}>Search Card</button>
            <br/>
            ...
            <button type="button" id="addCardButton" class="buttons" onClick={addCard}>add Card</button>
            <br/>
